<template>
    <div class="intro-text intro">
        <p class="p-4">Una vez visto en principio de todo, queremos explicar este proyecto en el que queremos volcar toda nuestra
            ...
            debería ser una sorpresa dar o recibir ayuda de personas que no forman parte de nuestro día a día, ¡¡¡LO HA
            SIDO!!! y eso nos ha hecho recapacitar y pensar........

            ¿Si forzamos el encuentro de todas esas personas que están dispuestas a ayudar a los demás y tambíen
